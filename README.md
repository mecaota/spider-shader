...
シェーダーの詳細な解説・パラメーター一覧は[パッケージ内のREADME](Packages/com.mecaota.spider-shader/README.md)を参照してください。
...
[Releases](https://github.com/mecaota/spider-shader/releases)から`com.mecaota.spider-shader-x.y.z.zip`をダウンロードし、Unityプロジェクトの`Packages/com.mecaota.spider-shader/`に展開してください（`.unitypackage`版もあります）。
